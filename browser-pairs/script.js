...
$(function(){
	...
	loader.addImage('images/nn/吃菜菜1.jpg');
	loader.addImage('images/nn/吃菜菜2.jpg');
	loader.addImage('images/nn/吃蘋果1.jpg');
	loader.addImage('images/nn/吃蘋果2.jpg');
	loader.addImage('images/nn/便盆1.jpg');
	loader.addImage('images/nn/便盆2.jpg');
	loader.addImage('images/nn/剃毛1.jpg');
	loader.addImage('images/nn/剃毛2.jpg');
	loader.addImage('images/nn/剪指甲1.jpg');
	loader.addImage('images/nn/剪指甲2.jpg');
	loader.addImage('images/nn/量體重1.jpg');
	loader.addImage('images/nn/量體重2.jpg');
	loader.addImage('images/nn/戴柚子1.jpg');
